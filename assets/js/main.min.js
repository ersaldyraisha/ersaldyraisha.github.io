...
var App = {
    ...
    angular: function (_angular) {
        ...
        angular.module('portfolio-app', ['slick']).controller('mainCtrl', ['$http', '$scope', function ($http, $scope) {
            ...
            $scope.headEnter = function () {
                $scope.head = 'head2';
            };

            $scope.headLeave = function () {
                $scope.head = 'head1';
            };
